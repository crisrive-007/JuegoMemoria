...
public class juego extends javax.swing.JFrame {
    ...
    private void btnEnabled(JButton btn) {
        ...
        if (!caraUp) {
            ...
            if (Im1.getDescription().compareTo(Im2.getDescription()) == 0) {
                // Los botones coinciden, aumentamos el puntaje del jugador actual
                if (turno == 1) {
                    puntajeJugador1 += 20;
                } else {
                    puntajeJugador2 += 20;
                ...
                // Los botones no coinciden, cambiamos de turno
                if (turno == 1) {
                    turno = 2;
                } else {
                    turno = 1;
            ...
            puntos1.setText("Jugador 1: " + puntajeJugador1);
            puntos2.setText("Jugador 2: " + puntajeJugador2);
            pregwin();
            compare();
        }
    }
    ...
    private void actualizarTurno() {
        if (turno == 1) {
            JOptionPane.showMessageDialog(this, "Turno del Jugador 1 - Puntaje: " + puntajeJugador1);
        } else {
            JOptionPane.showMessageDialog(this, "Turno del Jugador 2 - Puntaje: " + puntajeJugador2);
        }
    }
    ...
    private void mostrarResultados() {
        ...
        if (puntajeJugador1 > puntajeJugador2) {
            mensaje = "Felicidades Jugador 1, has ganado. Tu puntaje es: " + puntajeJugador1;
        } else if (puntajeJugador1 < puntajeJugador2) {
            mensaje = "Felicidades Jugador 2, has ganado. Tu puntaje es: " + puntajeJugador2;
        } else {
            mensaje = "¡Empate! Puntajes: Jugador 1 - " + puntajeJugador1 + ", Jugador 2 - " + puntajeJugador2;
        }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(puntos1, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(89, 89, 89)
                                .addComponent(puntos2, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
